<template>
  <div class="group">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>节点组管理</el-breadcrumb-item>
    ...
    <div class="rightWrap">
      ...
      <div>
        <el-row style="text-align:left;margin-top:15px;">
          <el-button type="primary" @click="dialogFormVisible = true" size="small">添加组</el-button>
        </el-row>
      </div>
      <!-- 表单 -->
      <div>
    ...
    <!-- 添加弹框 -->
    <el-dialog title="添加组" :visible.sync="dialogFormVisible" width="35%" id="add">
      <el-form :model="ruleForm" ref="ruleForm" :rules="rules">
        <el-form-item label="组名称:" :label-width="formLabelWidth" style="color:#000" prop="name">
  ...
  methods: {
    ...
    open2() {
      ...
      this.$confirm("此操作将永久删除该数据, 是否继续?", "提示", {
        ...
        this.$http
          .post(
            this.GLOBAL.xgurl + "/park-api/park/group/deleteGroup",
            {
              id: id
            },
            {
    ...
    saveEdit() {
      ...
      this.$http
        .post(
          this.GLOBAL.xgurl + "/park-api/park/group/saveOrUpdateGroup",
          this.editForm,
          {
            headers: {
              "Content-Type": "application/json;charset=UTF-8"
    ...
    handleEdit(event) {
      ...
      this.$http
        .post(
          this.GLOBAL.xgurl + "/park-api/park/group/findGroupById",
          { id: id },
          {
            headers: {
              "Content-Type": "application/json;charset=UTF-8"
